...
namespace QLCHBanGaRan {
    ...
    public partial class InvoiceDataset : global::System.Data.DataSet {
        ...
        public partial class HoaDonDataTable : global::System.Data.TypedTableBase<HoaDonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public HoaDonRow AddHoaDonRow(string MaHD, string MaNV, System.DateTime NgayLapHD, decimal TongTien) {
...
namespace QLCHBanGaRan.InvoiceDatasetTableAdapters {
    ...
    public partial class HoaDonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[HoaDon] WHERE (([MaHD] = @Original_MaHD) AND ((@IsNull_MaNV = 1 AND [MaNV] IS NULL) OR ([MaNV] = @Original_MaNV)) AND ([NgayLapHD] = @Original_NgayLapHD) AND ((@IsNull_TongTien = 1 AND [TongTien] IS NULL) OR ([TongTien] = @Original_TongTien)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[HoaDon] ([MaHD], [MaNV], [NgayLapHD], [TongTien]) VALUES (@MaH" +
                "D, @MaNV, @NgayLapHD, @TongTien);\r\nSELECT MaHD, MaNV, NgayLapHD, TongTien FROM H" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[HoaDon] SET [MaHD] = @MaHD, [MaNV] = @MaNV, [NgayLapHD] = @NgayLapHD, [TongTien] = @TongTien WHERE (([MaHD] = @Original_MaHD) AND ((@IsNull_MaNV = 1 AND [MaNV] IS NULL) OR ([MaNV] = @Original_MaNV)) AND ([NgayLapHD] = @Original_NgayLapHD) AND ((@IsNull_TongTien = 1 AND [TongTien] IS NULL) OR ([TongTien] = @Original_TongTien)));
SELECT MaHD, MaNV, NgayLapHD, TongTien FROM HoaDon WHERE (MaHD = @MaHD)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QLCHBanGaRan.Properties.Settings.Default.QLCHBanGaRanConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaHD, MaNV, NgayLapHD, TongTien FROM dbo.HoaDon";
        ...
        public virtual int Fill(InvoiceDataset.HoaDonDataTable dataTable) {
        ...
        public virtual InvoiceDataset.HoaDonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            InvoiceDataset.HoaDonDataTable dataTable = new InvoiceDataset.HoaDonDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InvoiceDataset.HoaDonDataTable dataTable) {
        ...
        public virtual int Delete(string Original_MaHD, string Original_MaNV, System.DateTime Original_NgayLapHD, global::System.Nullable<decimal> Original_TongTien) {
        ...
        public virtual int Insert(string MaHD, string MaNV, System.DateTime NgayLapHD, global::System.Nullable<decimal> TongTien) {
            if ((MaHD == null)) {
        ...
        public virtual int Update(string MaHD, string MaNV, System.DateTime NgayLapHD, global::System.Nullable<decimal> TongTien, string Original_MaHD, string Original_MaNV, System.DateTime Original_NgayLapHD, global::System.Nullable<decimal> Original_TongTien) {
            if ((MaHD == null)) {
                throw new global::System.ArgumentNullException("MaHD");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MaNV, System.DateTime NgayLapHD, global::System.Nullable<decimal> TongTien, string Original_MaHD, string Original_MaNV, System.DateTime Original_NgayLapHD, global::System.Nullable<decimal> Original_TongTien) {
            return this.Update(Original_MaHD, MaNV, NgayLapHD, TongTien, Original_MaHD, Original_MaNV, Original_NgayLapHD, Original_TongTien);
        }
    }
