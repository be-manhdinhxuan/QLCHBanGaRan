...
namespace QLCHBanGaRan.Forms
{
    public partial class frm_TimeSheetEmployee : Form
    {
        ...
        private void frm_TimeSheetEmployee_Load(object sender, EventArgs e)
        {
