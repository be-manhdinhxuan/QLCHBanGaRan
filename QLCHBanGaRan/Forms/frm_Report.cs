...
namespace QLCHBanGaRan.Forms
{
    public partial class frm_Report : Form
    {
        ...
        private void btnRpHoSoNV_Click(object sender, EventArgs e)
        {
            ...
            if (!Forms.frm_Main.Instance.Controls.ContainsKey("UC_RpProfileAllEmployess"))
            {
                UC_RpProfileAllEmployess profileAllEmployess = new UC_RpProfileAllEmployess();
                profileAllEmployess.Dock = DockStyle.Fill;
                Forms.frm_Main.Instance.Controls.Add(profileAllEmployess);
            }
            Forms.frm_Main.Instance.Controls["UC_RpProfileAllEmployess"].BringToFront();

        }

        private void btnRpChamCong_Click(object sender, EventArgs e)
        {
            if (!Forms.frm_Main.Instance.Controls.ContainsKey("UC_RpTimeSheet"))
            {
        ...
        {
            if (!Forms.frm_Main.Instance.Controls.ContainsKey("UC_RpRevenue"))
            {
        ...
        {
            if (!Forms.frm_Main.Instance.Controls.ContainsKey("UC_InvoiceDetails"))
            {
        ...
        {
            if (!Forms.frm_Main.Instance.Controls.ContainsKey("UC_RpProductInventory"))
            {
