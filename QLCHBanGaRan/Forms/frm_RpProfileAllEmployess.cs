...
{
    public partial class frm_RpProfileAllEmployess : Form
    {
        public frm_RpProfileAllEmployess()
        {
            InitializeComponent();
        }

        private void frm_RpProfileAllEmployess_Load(object sender, EventArgs e)
        {
