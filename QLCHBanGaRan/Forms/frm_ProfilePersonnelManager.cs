...
{
    public partial class frm_ProfilePersonnelManager : Form
    {
        private int check = 0;
        private string maNV = null;

        public frm_ProfilePersonnelManager()
        {
            InitializeComponent();
        }
        ...
        private void frm_ProfilePersonnelManager_Load(object sender, EventArgs e)
        {
